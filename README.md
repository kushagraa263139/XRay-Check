...
This project aims to classify chest X-ray images into three categories: COVID-19, Viral Pneumonia, and Normal, using a Convolutional Neural Network (CNN) model.
The project also includes a deployment using Streamlit for interactive web-based prediction of chest X-ray images.
* Test Images: [Sample Images for Testing Model](Test_images)
...
To run the Streamlit app, follow these steps from the repository root:
...
1. Install the required dependencies, Run the Streamlit app:
   ...
   ```
2. Upload a chest X-ray image and click the "Predict Now" button to get the result.
